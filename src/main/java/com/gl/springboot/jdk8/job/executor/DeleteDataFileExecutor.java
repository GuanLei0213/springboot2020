...
/**
 * @Description: 公共删除数据文件执行者
 * @Auther: za-guanlei
 * @Date: 2021/05/18/11:47
 */
@Slf4j
@Component
public class DeleteDataFileExecutor implements BiConsumer<DataFileTypeEnum, DataFileContext> {
    ...
    public void accept(DataFileTypeEnum dataFileTypeEnum,  DataFileContext dataFileContext) {
        ...
        if (!resultVO.isSuccess())
            return;
        log.info("数据文件[{}]执行公共删除逻辑成功.......",dataFileTypeEnum.getDesc());
    }
}
